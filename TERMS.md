...
> **NOTE TO MAINTAINER:** This document is a placeholder. It must be reviewed by qualified legal counsel before being hosted publicly or linked from store listings. Apple's standard EULA may be used as a fallback; if so, document that decision in the App Store Connect listing.
...
You must be 13 or older. If you are under 18, your parent or guardian must accept these Terms on your behalf.

## 3. Account

- You are responsible for keeping your account credentials confidential.
- You must provide accurate information (display name, weight, gym, gender, date of birth).
...
- Use the app only for lawful BJJ training purposes.
- Respect other athletes (no harassment, hate speech, or threats).
- Record matches only with the explicit consent of all participants.

You agree **not** to:

- Misrepresent your weight, skill level, or identity to gain a competitive advantage.
- Upload videos or photos that you do not have the rights to share.
- Reverse-engineer, decompile, or attempt to extract source code.
- Use the app to coordinate match-fixing or ELO manipulation.
...
We may modify or discontinue features at any time. We will provide reasonable notice of material changes when possible.

## 8. Termination

You may delete your account at any time from Settings. We may suspend or terminate accounts that violate these Terms, with or without notice.
...
**TBD** (placeholder, choose governing jurisdiction and venue before publishing).
